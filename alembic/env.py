...
from backend.models import User, Job, Application, Subscription, Payment, ScheduledRun
...
def run_migrations_online() -> None:
    ...
    db_url = os.getenv("DATABASE_URL", "sqlite:///" + os.path.join(os.path.dirname(__file__), '..', 'app.db'))
